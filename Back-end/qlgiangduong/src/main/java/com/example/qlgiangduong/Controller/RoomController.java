...
public class RoomController {
    ...
    @PostMapping("/getCapacityAndToolByRoom")
    public Object getCapacityAndToolByRoom(@RequestBody Room room) {
        return roomService.getCapacityAndToolByRoom(room.getRoom());
    }
